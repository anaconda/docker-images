...
#  $ docker build . -t continuumio/miniconda:4.6.14-alpine -t continuumio/miniconda2:4.6.14-alpine
#  $ docker push continuumio/miniconda:4.6.14-alpine
...
ENV CONDA_MD5 faa7cb0b0c8986ac3cacdbbd00fe4168
